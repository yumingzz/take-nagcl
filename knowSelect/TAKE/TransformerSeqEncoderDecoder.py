...
class TransformerSeqEncoder(nn.Module):
    def __init__(self, args, vocab2id, id2vocab, emb_matrix=None):
        ...
        # self.enc = BertModel.from_pretrained('/root/autodl-tmp/bert-base-uncased', local_files_only=True)
        from transformers import BertModel, BertConfig
        self.enc = BertModel.from_pretrained(
            '/root/autodl-tmp/bert-base-uncased',
            config=BertConfig.from_pretrained('/root/autodl-tmp/bert-base-uncased', local_files_only=True),
